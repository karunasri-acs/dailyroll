	...
	if($file !=''){
		...
		if(move_uploaded_file($_FILES['fileToUpload']['tmp_name'], $file_path)){
		  ...
		  if($type==1){
			...
			$sql="UPDATE `income` SET `account_id`='$account',`income_amount`='$amount', `file_name`='$res',`subcat_id`='$subcategory',`cat_id`='$category',`description`='$description',`tr_date`='$date',`updateddate`='$pdate' WHERE income_id='$id'";
	$log->event_log($sql,'d');
	

		 }else{
			 $sql="UPDATE `expenses` SET `account_id`='$account',`amount`='$amount', `file_name`='$res',`description`='$description',`subcat_id`='$subcategory',`cat_id`='$category',`tr_date`='$var',`updateddate`='$pdate' WHERE `id`='$id'";
		 ...
		 if($type==1){
			 	...
			 	$sql=" UPDATE `income` SET `account_id`='$account',`income_amount`='$amount', `subcat_id`='$subcategory',`cat_id`='$category',`description`='$description',`tr_date`='$date',`updateddate`='$pdate' WHERE income_id='$id'";
			$log->event_log($sql,'d');
	
			 
			
		 }else{
			 $sql="UPDATE `expenses` SET `account_id`='$account',`amount`='$amount',`description`='$description',`subcat_id`='$subcategory',`cat_id`='$category',`tr_date`='$var',`updateddate`='$pdate' WHERE `id`='$id'";
