...
//$log->$log->event_log('root file beginning ','d'); 
    ...
    */
	...
	if($setamount >= $amount){
	$sql="INSERT INTO `income`( `capture_id`, `account_id`, `income_amount`, `cat_id`,`subcat_id`, `description`, `tr_date`,`pendingflag`,`file_name`)  
									VALUES ('$unid','$account','$amount','$category','$subcatid','$description','$date','$addstatus','$filepath')";
