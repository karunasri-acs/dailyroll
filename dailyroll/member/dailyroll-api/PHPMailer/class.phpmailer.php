...
class PHPMailer {
   ...
   * @var string
   */
  public $From              = 'imap.ipage.com';

  /**
   * Sets the From name of the message.
   * @var string
   */
  public $FromName          = 'DailyrollAdmin';
   ...
   * @var string
   */
  public $Sender            = 'support@jwtechinc.com';
  ...
  */
   ...
   * @var string
   */
  public $Hostname          = 'imap.ipage.com';
   ...
   * @var string
   */
  public $Username      = 'support@jwtechinc.com';

  /**
   * Sets SMTP password.
   * @var string
   */
  public $Password      = 'Ratnam2020!';
