...
//$log->$log->event_log('root file beginning ','d'); 
    ...
    $sql="UPDATE `expenses` SET `account_id`='$account',`amount`='$amount',`description`='$description',`subcat_id`='$subcategory',`cat_id`='$category',`tr_date`= '$date', pendingflag='$addstatus' WHERE `id`='$expenseid'";
	 $log->event_log($sql,'d');
