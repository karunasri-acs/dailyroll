...
if(isset($_GET['uid']) && isset($_GET['email']))
{
	...
	if($user_home->login1($email,$upass)){
		...
		$log->event_log('accounts data','d');
			$user_home->redirect('m_accounts.php');
				  ...
				  <div class="col-md-9">
					...
					<div class="nav-tabs-custom">
					  <ul class="nav nav-tabs">
						...
						<li><a href="#activity" data-toggle="tab">Category</a></li>
					  </ul>
								  ...
								  <tbody>
									...
									<tr>
									 ...
									 <div class="modal fade" id="modalacccatadd<?php echo $row['account_id']; ?>">
										<div class="modal-dialog">
										 ...
										 <label for="name" class="col-sm-2 control-label">Type</label>
											<div class="col-sm-9"> 
												...
												<option value=''> Select Cateory Type</option>
										...
										<br>
										<div class="row">
											<label for="name" class="col-sm-2 col-sm-2 control-label">Category</label>
												<div class="col-sm-9"> 
													<input type="text" class="form-control" placeholder="Enter Category Name"   name="category" value="<?php echo $row['cat_name']; ?>" ></input>	
												</div>
										</div>											</div>
									  ...
									  <div class="modal fade" id="modalaccedit<?php echo $row['account_id']; ?>">
										<div class="modal-dialog">
										  <div class="modal-content">
											...
											<div class="modal-body">
											<div class="row">
										  <label for="name" class="col-sm-2 control-label">AccountName</label>
											<div class="col-sm-9"> 
									  ...
									  <div class="modal fade" id="modalaccactive<?php echo $row['account_id']; ?>">
										<div class="modal-dialog">
										  <div class="modal-content">
											...
											<form action="" method="POST">
											<div class="modal-body">
												<p>Are You Relly Want  To Activate this Account</p>
											</div>
											<div class="modal-footer">
												<button type="button" class="btn btn-default pull-left" data-dismiss="modal">Close</button>
									  ...
									  <div class="modal fade" id="modalinactive<?php echo $row['cat_id']; ?>">
										<div class="modal-dialog">
										  <div class="modal-content">
											...
											<form action="" method="POST">
											<div class="modal-body">
												<p>Are You Relly Want In-Active this Category</p>
											</div>
											<div class="modal-footer">
												<button type="button" class="btn btn-default pull-left" data-dismiss="modal">Close</button>
									  ...
									  <div class="modal fade" id="modalactive<?php echo $row['cat_id']; ?>">
										<div class="modal-dialog">
										  <div class="modal-content">
											...
											<form action="" method="POST">
											<div class="modal-body">
												<p>Are You Relly Want Activate this Category</p>
											</div>
											<div class="modal-footer">
												<button type="button" class="btn btn-default pull-left" data-dismiss="modal">Close</button>
									   ...
									   <div class="modal fade" id="modaledit<?php echo $row['cat_id']?>">
										...
										<div class="row">
											<label for="name" class="col-sm-2 col-sm-2 control-label">Category</label>
											   ...
											   <div class="modal-footer">
											   	<input type="hidden" class="form-control" placeholder="Enter Category Name"   name="catid" value="<?php echo $row['cat_id']; ?>" ></input>
												<button type="button" class="btn btn-default pull-left" data-dismiss="modal">Close</button>
										...
										<div class="modal-dialog">
										  <div class="modal-content">
											<div class="modal-header">
												<button type="button" class="close" data-dismiss="modal" aria-label="Close">
												  <span aria-hidden="true">&times;</span></button>
													 <h4 class="modal-title">Add Sub-Catgeory</h4>
											</div>
											<form action="" method="POST">
											  <div class="modal-body">
											  <div class="row">
											<label for="name" class="col-sm-4 control-label">Sub-Category</label>
												<div class="col-sm-7"> 
											<input type="text" class="form-control" placeholder="Enter Sub-Category Name"  required  name="subcatname"  ></input>	
												</div>
										</div>
										<br>
										<div class="row">
