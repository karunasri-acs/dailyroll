...
if(isset($_POST['button'])){
	...
	if(move_uploaded_file($_FILES['fileToUpload']['tmp_name'], $file_path)){
		$sql="INSERT INTO `feedbacks`(`email`, `address`, `date`, `description`, `status`,`document`) VALUES ('$email2','$address','$date','$message','normal','$file')";
		...
		$msg = "<div class='alert alert-success alert-dismissible' role='alert'>
		 ...
		 $sql="INSERT INTO `feedbacks`(`email`, `address`, `date`, `description`, `status`) VALUES ('$email2','$address','$date','$message','normal')";
			$stmt = $user_home->runQuery($sql);
			$stmt->execute();
            ...
            <div class="row contact-us">
              ...
              <div class="col-md-10">
                <form  action="" method="post"  enctype="multipart/form-data">
                  <?php echo $msg;?>
				  <input type="email" id="ip2" class="form-input w-100" disabled name="email" value=<?php echo $email2; ?>>
				  <br>
				  <br>
