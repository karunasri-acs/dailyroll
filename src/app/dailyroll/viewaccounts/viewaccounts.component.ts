...
this.getCurrency();
  ...
  changeusertypestatus(){
        ...
        debugger;
        this.myacraved = false;
    this.accountservice.changeusertype(this.editedProduct,this.account_id,q).subscribe(
      res => {
        this.myacraved = true;
    swal(res);
    this.getList();
      ...
      getAccountName() {
        var q=6
          ...
          addMemberToGroup() {
            var q=7
            debugger;
          if(this.memberemail !=null  && this.membername !=null && this.memberphoneno !=null && this.selectusertype !=null ){
                this.accountservice.addMember(this.account_id,this.memberemail,this.membername,this.memberphoneno,this.selectusertype,q).subscribe(
                  res => {
                 swal(res);
                 this.getList();
